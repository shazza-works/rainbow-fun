# Version 9.5.3 Omega Made for Pythonista 3 By: SavSec - I Don't Give A Fuck License - Debugging:
# SavSec, PotatoGod API Script: SavSec
	...
	try:
		...
		if line.startswith("l:"):
			...
			if ":" not in line and "!" not in line:
				...
				execute_api()
				print
def bloodforum(): # BloodForum is used on Hacker's Forum Page To Make Blood Text
	try:
		...
		pass
def updown(): # UpDown Makes Your Text Go Up And Down
	...
	try:
		...
		if verbose: print traceback.print_exc(file=sys.stdout)
		pass
def captcha(): # Makes text almost impossible to read
	colors = ["#i","#/i","#i","#/i"]
	s = 0
	new = ""
	msgb = ""
	try:
		...
		if verbose: print traceback.print_exc(file=sys.stdout)
		pass
def italics(): # italics or not italics, which one?
	colors = ["#i","#/i","#i","#/i"]
	s = 0
	new = ""
	msgb = ""
...
def liner(): # so many lines!
	...
	try:
		...
		if verbose: print traceback.print_exc(file=sys.stdout)
		pass
def undercolor(): # Undercolor Provides a Under Beam of Colour
	colors = ["#ff0000"]
	colors = rainbowfade
	s = 0
	new = ""
...
def l33t():
	try:
		...
		pass
def fancy(cl="ord"):
	# Font Types ord - Ordered cycle through all font options ran - Random choice of font
	# options rancycle - Randomly choose 1 font to cycle with 1 - font 1, Candy-Cain-Like font
	# structure 2 - font 2, blue and yellow lightning-like font structure 3 - font 3, black
	# and yellow storm font structure 4 - font 4, light prism font structure
